...
from webservices.resources import (
    default_year, natural_number, SingleResource, Searchable
)
...
class CandidateFormatMixin(object):
    ...
    def format(self, data_dict, page_data, year):
        ...
        for cand in data:
            ...
            for cmte in cand.get('affiliated_committees', []):
                ...
                if cmte['dimcmte'][0]['dimcmteproperties'][0]:
                    ...
                    committee['committee_name'] = \
                        cmte['dimcmte'][0]['dimcmteproperties'][-1]['cmte_nm']
            ...
            for prop in cand['dimcandproperties']:
                ...
                for api_name, fec_name in self.property_fields_mapping:
                    if fec_name in prop and fec_name not in ('cand_nm',
                                                             'expire_date'):
                ...
                if ('cand_nm' in prop and other_names in fields
