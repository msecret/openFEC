-- run on data access machine to create foreign tables to FEC's Oracle

CREATE FOREIGN TABLE processed_fec.cand_status_ici (
...
CREATE FOREIGN TABLE processed_fec.form_1 (
...
CREATE FOREIGN TABLE processed_fec.form_10 (
...
CREATE FOREIGN TABLE processed_fec.form_11 (
...
CREATE FOREIGN TABLE processed_fec.form_12 (
...
CREATE FOREIGN TABLE processed_fec.form_13 (
    ...
    load_date date NOT NULL,
    update_date date
) SERVER oradb OPTIONS (schema 'PROCESSED', table 'form_13');
...
CREATE FOREIGN TABLE processed_fec.form_1m (
...
CREATE FOREIGN TABLE processed_fec.form_1s (
...
CREATE FOREIGN TABLE processed_fec.form_2 (
...
CREATE FOREIGN TABLE processed_fec.form_24 (
...
CREATE FOREIGN TABLE processed_fec.form_2s (
...
CREATE FOREIGN TABLE processed_fec.form_3 (
...
CREATE FOREIGN TABLE processed_fec.form_3l (
...
CREATE FOREIGN TABLE processed_fec.form_3p (
...
CREATE FOREIGN TABLE processed_fec.form_3p_line_31s (
...
CREATE FOREIGN TABLE processed_fec.form_3ps (
...
CREATE FOREIGN TABLE processed_fec.form_3s (
...
CREATE FOREIGN TABLE processed_fec.form_3x (
...
CREATE FOREIGN TABLE processed_fec.form_3z (
...
CREATE FOREIGN TABLE processed_fec.form_4 (
...
CREATE FOREIGN TABLE processed_fec.form_5 (
...
CREATE FOREIGN TABLE processed_fec.form_6 (
...
CREATE FOREIGN TABLE processed_fec.form_7 (
...
CREATE FOREIGN TABLE processed_fec.form_8 (
...
CREATE FOREIGN TABLE processed_fec.form_9 (
...
CREATE FOREIGN TABLE processed_fec.form_99_misc (
...
CREATE FOREIGN TABLE processed_fec.log_audit_dml (
...
CREATE FOREIGN TABLE processed_fec.log_audit_module (
...
CREATE FOREIGN TABLE processed_fec.log_audit_process (
...
CREATE FOREIGN TABLE processed_fec.log_dml_errors (
...
CREATE FOREIGN TABLE processed_fec.ref_cand_ici (
...
CREATE FOREIGN TABLE processed_fec.ref_cmte_type (
...
CREATE FOREIGN TABLE processed_fec.ref_form_type (
